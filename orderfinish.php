            ...
            <td colspan="2" style="width: 100%">
                <div class="zone" style="height: 34mm;position: relative;font-size: 5mm;">
                    ...
                    <div style="position: absolute; right: 3mm; bottom: 3mm; text-align: right; font-size: 4mm; ">
                        Nama Paket: <b><?php echo $isi_tbl['nama_paket']; ?></b><br>
                        Total Biaya : <b><?php echo $total_harga; ?> IDR</b><br>
                        Code Pesan : <b><?php echo $num; ?></b><br>
                    </div>
					<img src="images/designkita.png" width="100" height="99" />
                    <span style="position: absolute; left: 32mm; top: 10mm; font-size: 28px; color: red">DESIGNkita</span><br />
                    <span style="position: absolute; left: 32mm; top: 18mm; font-size: 16px;">Bukti Transaksi, <?php echo $date; ?></span>
        ...
        <tr>
			...
			<td style="width: 25%;">
                <div class="zone" style="height: 40mm;vertical-align: middle;text-align: center;">
                    <img src="images/barcode.png" width="150" height="149" />
                </div>
            </td>
            ...
            <td style="width: 75%">
                ...
                <h2> <b>Note :</b><br></h2>
					<h4>Bukti Pembayaran ini harap kirimkan pada Admin dengan cara scan QR CODE disamping atau melalui kontak yang terserdia pada halaman menu kontak, Nantinya File Template akan dikirimkan melalui google drive.<br>
					<br></h4>

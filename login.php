	...
	$user = new user();
	 ...
	 ?>
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/ui4.jpg);">
				<div class="desc">
					<div class="container">
						<div class="row">
								   ...
								   <!-- Tab panes -->
									...
									<div class="tab-content">
									 ...
									 <div role="tabpanel" class="tab-pane" id="flights">
										<div class="row">
										<h1 align="center">Login Ke DESIGNkita</h1>
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<h2 align="center">Hanya di DESIGNkita </h2>
									<h3 align="center">Untuk Hasil Tampilan Aplikasi Yang Menarik</h3>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p>Silahkan daftar untuk mendapatkan akun DESIGNkita</p>
					</div>
				</div>
				<form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
					<div class="row animate-box">
						<div class="col-md-6">
							<h3 class="section-title">DESIGNkita</h3>
							<p>Melyani Kebutuhan Design Aplikasi Anda</p>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>JL KILANG, KOTA SORONG</li>
								<li><i class="icon-phone2"></i>0812 4038 3361</li>
								<li><i class="icon-mail"></i><a href="#">stringtzyro@gmail.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">designkita.com</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">

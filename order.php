  ...
  <!-- 
	...
	<body>
		...
		<div class="fh5co-hero">
			<div class="fh5co"></div>
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(images/ui6.jpg);">
				<div class="desc">
					<div class="container">
						<div class="row">
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<h2 align="center">Silahkan Pilih Paket Design Terbaikmu</h2>
									<h3 align="center">Hanya Di DESIGNkita</h3>
			...
			<div class="container">
				...
				<form action="proses.php?aksi=tambah_order" method="post" enctype="multipart/form-data">
					...
					<div class="row animate-box">
						<div class="col-md-6">
							<h3 class="section-title">Ketentuan Pembelian</h3>
...
<li>Pilih konsultan sesuai kebutuhan anda</li>
						...
						<div class="col-md-6">
							<div class="row">
								...
								<div class="col-md-6">
										<label>Pilih Paket Template</label>
									<div class="form-group">
										<select name="id_paket" class="form-control">
										<option value="">--Pilih Paket Template-</option>
<?php						
...
<?php endforeach; ?>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<option value="">--Pilih Mentor Konsultasi-</option>
<?php						
...
<?php endforeach; ?>
								...
								<div class="col-md-6">
										<div class="input-field">
													<label for="date-start">Tgl Konsultasi</label>
